...
( function( $ ) {
    $( document ).ready( function () {
        ...
        wcz_stickcart();
        $( '#customize-control-wcz-enable-stickcart input[type=checkbox]' ).on( 'change', function() {
            wcz_stickcart();
        });
        function wcz_stickcart() {
            if ( $( '#customize-control-wcz-enable-stickcart input[type=checkbox]' ).is( ':checked' ) ) {
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-position' ).show();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-layout' ).show();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-edit' ).show();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-remove-onmobile' ).show();
            } else {
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-position' ).hide();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-layout' ).hide();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-edit' ).hide();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-remove-onmobile' ).hide();
            }
        }
        wcz_stickcart_editdesign();
        $( '#customize-control-wcz-stickcart-edit input[type=checkbox], #customize-control-wcz-enable-stickcart input[type=checkbox]' ).on( 'change', function() {
            wcz_stickcart_editdesign();
        });
        function wcz_stickcart_editdesign() {
            if ( $( '#customize-control-wcz-enable-stickcart input[type=checkbox]' ).is( ':checked' ) && $( '#customize-control-wcz-stickcart-edit input[type=checkbox]' ).is( ':checked' ) ) {
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-remimg' ).show();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-remprice' ).show();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-remrating' ).show();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-title-size' ).show();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-fullwidth' ).show();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-bgcolor' ).show();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-fontcolor' ).show();
            } else {
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-remimg' ).hide();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-remprice' ).hide();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-remrating' ).hide();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-title-size' ).hide();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-fullwidth' ).hide();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-bgcolor' ).hide();
                $( '#sub-accordion-section-wcz-panel-product #customize-control-wcz-stickcart-fontcolor' ).hide();
            }
        }
